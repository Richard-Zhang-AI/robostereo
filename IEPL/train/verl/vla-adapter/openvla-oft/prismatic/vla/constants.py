...
IGNORE_INDEX = -100
# ACTION_TOKEN_BEGIN_IDX = 31743  # For LLaMA2 tokenizer
ACTION_TOKEN_BEGIN_IDX  = 31744  # Corrected: actual action tokens start from 31745
STOP_INDEX = 2  # '</s>'
NUM_TOKENS = 64
...
def detect_robot_platform():
    ...
    if "libero" in cmd_args:
        ...
        return "BRIDGE"
    elif "realworld" or "block" in cmd_args:
        return "REALWORLD"
    else:
