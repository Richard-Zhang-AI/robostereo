...
from cosmos_predict2._src.imaginaire.checkpointer.local_pt import Checkpointer as LocalPtCheckpointer
...
LOCAL_PT_CHECKPOINTER: Dict[str, str] = L(LocalPtCheckpointer)()
...
def register_ckpt_type():
    ...
    cs.store(group="ckpt_type", package="checkpoint.type", name="local_pt", node=LOCAL_PT_CHECKPOINTER)
