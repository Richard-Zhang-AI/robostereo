...
class CameraMiniTrainDITwithConditionalMask(CameraMiniTrainDIT):
    ...
    def forward(
        ...
        **kwargs,
        ...
        # Extract intermediate_feature_ids from kwargs before deleting
        # This allows backward compatibility with old code that doesn't pass this parameter
        if intermediate_feature_ids is None and "intermediate_feature_ids" in kwargs:
            intermediate_feature_ids = kwargs.pop("intermediate_feature_ids")
        del kwargs
