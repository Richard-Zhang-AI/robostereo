...
class CheckpointConfig:
    ...
    # Optional weight-only save paths (pt files). Relative paths are resolved under job.path_local.
    save_path: str = ""
    save_path_rgb: str = ""
    save_path_xyz: str = ""
    ...
    load_path: str = ""
    # Whether to resume from a previous checkpoint (latest_checkpoint.txt or load_path).
    # This does not affect model-specific init weights (e.g., dual-tower RGB/XYZ init).
