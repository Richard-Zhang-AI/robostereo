...
EXPERIMENT_NAME='stack_three_wmpo_128'

TASK_NAME="stack_three"
UNNORM_KEY="$TASK_NAME"_d0_300_demos

SFT_MODEL_PATH="./checkpoint_files/SFT_models/stack_three"
REWARD_MODEL_PATH="./checkpoint_files/reward_models/videomae_stack_three.pth"
...
HYDRA_FULL_ERROR=1 python -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.wm.inference_config_path=./checkpoint_files/world_models/stack_three/P_128/inference_cfg.py \
    actor_rollout_ref.wm.train_config_path=./checkpoint_files/world_models/stack_three/P_128/train_mimicgen_cfg.py \
    +actor_rollout_ref.wm.update_wm=False \
    actor_rollout_ref.wm.reward_model_path=$REWARD_MODEL_PATH \
    actor_rollout_ref.wm.rm_threshold=0.66 \
