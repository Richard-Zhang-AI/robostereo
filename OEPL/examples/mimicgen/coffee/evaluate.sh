...
export WANDB_API_KEY='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' #TODO: use your own WANDB_API_KEY
...
TARGET_MODEL_PATH="./checkpoint_files/OEPL_models/coffee/P_128"
...
HYDRA_FULL_ERROR=1 python -m verl.trainer.main_ppo \
    ...
    +actor_rollout_ref.rollout.save_vla_data=True \
    +actor_rollout_ref.rollout.vla_data_save_dir=./tmp_files/vla_training_data_$EXPERIMENT_NAME \
