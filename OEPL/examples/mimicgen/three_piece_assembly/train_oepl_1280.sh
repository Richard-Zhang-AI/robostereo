...
EXPERIMENT_NAME='three_piece_assembly_wmpo_1280' 

TASK_NAME="three_piece_assembly"
UNNORM_KEY="$TASK_NAME"_d0_300_demos

SFT_MODEL_PATH="$REPO_ROOT/checkpoint_files/SFT_models/three_piece_assembly"
REWARD_MODEL_PATH="$REPO_ROOT/checkpoint_files/reward_models/videomae_three_piece_assembly.pth"
...
HYDRA_FULL_ERROR=1 python -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.wm.inference_config_path=$REPO_ROOT/checkpoint_files/world_models/three_piece_assembly/P_1280/inference_cfg.py \
    actor_rollout_ref.wm.train_config_path=$REPO_ROOT/checkpoint_files/world_models/three_piece_assembly/P_1280/train_mimicgen_cfg.py \
